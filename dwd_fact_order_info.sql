...
select
    nvl(old.id,new.id),
    nvl(old.order_status,new.order_status),
    nvl(old.user_id,new.user_id),
    nvl(old.out_trade_no,new.out_trade_no),
    ...
    nvl(old.province_id,new.province_id),
    nvl(old.activity_id,new.activity_id),
    nvl(old.original_total_amount,new.original_total_amount),
    nvl(old.benefit_reduce_amount,new.benefit_reduce_amount),
    nvl(old.feight_fee,new.feight_fee),
    nvl(old.final_total_amount,new.final_total_amount),
